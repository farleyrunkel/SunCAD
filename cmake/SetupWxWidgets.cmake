...
#  If it is found, will set CMAKE_SUNCAD_HAS_WXWIDGETS=1
# ===================================================
...
set(wxWidgets_SUNCAD_COMPONENTS_TO_SEARCH "base;core;gl;adv;aui;html" CACHE STRING "Components to search in wxWidgets")

set(CMAKE_SUNCAD_HAS_WXWIDGETS 0)
...
find_package(wxWidgets COMPONENTS ${wxWidgets_SUNCAD_COMPONENTS_TO_SEARCH})
...
if(wxWidgets_FOUND)
	...
	SUNCAD_split_lib_list(wxWidgets_LIBRARIES wxWidgets_LIBRARIES_RELEASE optimized debug)
	SUNCAD_split_lib_list(wxWidgets_LIBRARIES wxWidgets_LIBRARIES_DEBUG debug optimized)
	...
	# For use in the SUNCADconfig.cmake
	set(CMAKE_SUNCAD_WX_ROOT_DIR ${wxWidgets_ROOT_DIR})

	set(CMAKE_SUNCAD_HAS_WXWIDGETS 1)
endif()

# It's always a system lib:
set(CMAKE_SUNCAD_HAS_WXWIDGETS_SYSTEM 0)
if(CMAKE_SUNCAD_HAS_WXWIDGETS)
	set(CMAKE_SUNCAD_HAS_WXWIDGETS_SYSTEM 1)
endif()
