...
Aspect_VKeyMouse QtMouseHelper::qtMouseButtons2VKeys(Qt::MouseButtons theButtons)
{
...
Aspect_VKeyFlags QtMouseHelper::qtMouseModifiers2VKeys(Qt::KeyboardModifiers theModifiers)
{
...
Aspect_VKey QtMouseHelper::qtKey2VKey(int theKey)
{
    switch(theKey)
    {
    case 1060: // ru
